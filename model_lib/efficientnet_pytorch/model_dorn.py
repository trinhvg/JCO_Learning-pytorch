...
class EfficientNet(nn.Module):
    ...
    def forward(self, inputs):
        ...
        if self.task_mode == 'class':
            ...
            predicts, softmax = self.ordinal_regression(c_out)
...
def dorn_efficientnet(task_mode='class', pretrained=True, num_classes=4, **kwargs):
    """
    ...
    model = func(task_mode=task_mode, model_name='efficientnet-b0', num_classes=(num_classes-1)*2)
    return model


# def _test():
#     net = dorn_efficientnet(task_mode='class', pretrained=True).cuda()
